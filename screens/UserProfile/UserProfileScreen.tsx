    ...
    <View style={styles.container}>
      ...
      <View style={styles.socialAccounts}>
        ...
        <View style={{marginTop: 50}}>
            ...
            {isFacebookLink ? (
              <Button variant="subtle" style={styles.socialButtons} onPress={disConnectFacebook}>Hủy kết nối</Button>
            ) : (
              <Button variant="subtle" style={styles.socialButtons} onPress={connectFacebook}>Kết nối</Button>
            )}
        ...
        <View style={{marginTop: 50}}>
            <View style={styles.socialButtons}>
              ...
              {isGoogleLink ? (
              <Button variant="subtle" style={styles.socialButtons} onPress={disConnectGoogle}>Hủy kết nối</Button>
              ) : (
              <Button variant="subtle" style={styles.socialButtons} onPress={connectGoogle}>Kết nối</Button>
              )}            
            </View>
